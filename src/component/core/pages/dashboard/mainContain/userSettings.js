        ...
        <div className="text-[#516067]">
          <div className="flex flex-col items-center pb-2 border-b border-slate-300">
            ...
            <div className="flex items-center gap-1">
              <h4 className="text-lg font-normal mt-2">{currentUser?.name}</h4>
              <Icon
          ...
          <div className="flex items-center gap-1">
            <h4 className="font-normal mt-2">{currentUser?.email}</h4>
            <Icon
              className="cursor-pointer relative top-1"
              icon="heroicons-outline:pencil"
            />
          ...
          <h4 className="font-normal mt-1">User Id: {currentUser?.userId}</h4>
          <h4 className="font-normal mt-1">
            Your account {currentUser?.metadata?.creationTime} to present.
          </h4>
          <h4 className="font-normal mt-1">
            Lest time you logged {currentUser?.metadata?.lastSignInTime}.
          </h4>
        </div>
      ) : (
